...
public class StatsFragment extends Fragment {
    ...
    private void addEntry(int voltaje, String fecha) {
        ...
        if (data != null) {
            ...
            data.addEntry(new Entry(set.getEntryCount(), (float) (voltaje)), 0);
    ...
    private void feedMultiple(int voltaje) {
    ...
    public void putArguments(Bundle args){
        ...
        int voltaje = Integer.parseInt(valueVoltaje);

        addEntry(voltaje, valueFecha);
    }
}
